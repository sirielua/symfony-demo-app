...
namespace App\Admin\EasyAdmin\Filter\Configurator;
...
use App\Admin\EasyAdmin\Filter\DateFilter;

/**
 * @author Yonel Ceruto <yonelceruto@gmail.com>
 * @author Javier Eguiluz <javier.eguiluz@gmail.com>
 */
final class DateConfigurator implements FilterConfiguratorInterface
{
    public function supports(FilterDto $filterDto, ?FieldDto $fieldDto, EntityDto $entityDto, AdminContext $context): bool
    {
        return DateFilter::class === $filterDto->getFqcn();
    }
